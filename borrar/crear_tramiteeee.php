...
<div class="cabecera"></div>
    ...
    <td><?php $PSql = "SELECT dxe_siglas,dxe_nombre FROM $t_dep_empresa WHERE dxe_estado=1;";
	          echo $Gen->ComboBox($PSql,"dxe_siglas","dxe_nombre","dempresa",$_POST['dempresa'],"onchange='javascript:recargar();'"); ?></td>
  </tr>
        <tr>
    <td width="130"><label>Consecutivo:</label></td>
    <td width="776"><input name="tra_consecutivo" type="text" id="recargado" value="<? if(isset($p[6])) echo $p[6]; else echo $_POST['max'];?>" readonly/></select></td>
  </tr>
  <tr>
