...
-- 
-- Servidor: localhost
-- Tiempo de generación: 11-07-2012 a las 17:28:11
...
INSERT INTO `admin_menu` VALUES (30, 'empresas_grupo', 'Grupo Empresas', 'Clasificación Empresas Cliente para su administración', '', '', 'gru_estado', 'gru_usu_id', 'gru_fechahora', 'gru_equipo', 0);
INSERT INTO `admin_menu` VALUES (28, 'tipo_documento', 'Tipo Documento', 'Tipo de Docmentos para los trámites', '', '', 'txd_estado', 'txd_usu_id', 'txd_fechahora', 'txd_equipo', 0);
INSERT INTO `admin_menu` VALUES (25, 'tramite_pasos', 'Etapas del tramite', 'Pasos o etapas de la ejecución del trámite', '', '', 'pxt_estado', 'pxt_usu_id', 'pxt_fechahora', 'pxt_equipo', 0);
...
INSERT INTO `admin_menu` VALUES (22, 'empresa_cliente', 'Empresas Cliente', 'Empresas Clientes', '', '', 'exc_estado', 'exc_usu_id', 'exc_fechahora', 'exc_equipo', 0);
INSERT INTO `admin_menu` VALUES (23, 'empresa_sedes', 'Sedes Empresa', 'Sedes de las Empresas Propias', 'dep_empresa', 'dxe_sede_id', 'sede_estado', 'sede_usu_id', 'sede_fechahora', 'sede_equipo', 0);
...
INSERT INTO `admin_menu` VALUES (20, 'ciudad', 'Ciudades', 'Ciudades de los departamentos del país', '', '', 'ciu_estado', 'ciu_usu_id', 'ciu_fechahora', 'ciu_equipo', 0);
...
INSERT INTO `admin_menu` VALUES (18, 'cargos', 'Cargos', 'Cargos en el Departamento de la empresa', '', '', 'car_estado', 'car_usu_id', 'car_fechahora', 'car_equipo', 0);
INSERT INTO `admin_menu` VALUES (17, 'dep_empresa', 'Departamentos Empresa', 'Departamentos de las empresas propias', 'cargos', 'car_dxe_id', 'dxe_estado', 'dxe_usu_id', 'dxe_fechahora', 'dxe_equipo', 0);
INSERT INTO `admin_menu` VALUES (1, 'empresa', 'Empresas Propias', 'Empresas del Grupo Alianza', 'empresa_sedes', 'sede_emp_id', 'emp_estado', 'emp_usu_id', 'emp_fechahora', 'emp_equipo', 0);
...
INSERT INTO `admin_permisos` VALUES (29, 1, 'empresa', 1);
...
CREATE TABLE `admin_tablas` (
  ...
  PRIMARY KEY  (`axt_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=144 ;

-- 
-- Volcar la base de datos para la tabla `admin_tablas`
-- 

INSERT INTO `admin_tablas` VALUES (123, 'empresa_cliente', 'exc_contacto', 0, 'text', '', '', '', '', '', '', 'Nombre persona contacto', 1, 0);
INSERT INTO `admin_tablas` VALUES (119, 'empresa_cliente', 'exc_nit', 0, 'text', '', '', '', '', '', '', 'Nit Empresa', 1, 0);
INSERT INTO `admin_tablas` VALUES (120, 'empresa_cliente', 'exc_direccion', 0, 'text', '', '', '', '', '', '', 'Dirección Empresa', 1, 0);
INSERT INTO `admin_tablas` VALUES (121, 'empresa_cliente', 'exc_fijo', 0, 'numero', '', '', '', '', '', '', 'Teléfono fijo (Solo Números)', 1, 0);
INSERT INTO `admin_tablas` VALUES (122, 'empresa_cliente', 'exc_celular', 0, 'numero', '', '', '', '', '', '', 'Teléfono celular (Solo Números)', 1, 0);
...
INSERT INTO `admin_tablas` VALUES (109, 'tramite_tipo_origen ', 'txo_nombre', 0, 'text', '', '', '', '', '', 'SI', 'Nombre Origen', 1, 0);
INSERT INTO `admin_tablas` VALUES (110, 'tramite_tipo_origen', 'txo_descripcion', 0, 'textareas', '', '', '', '', '', '', 'Descripción Origen', 1, 0);
INSERT INTO `admin_tablas` VALUES (111, 'tramite_estado', 'ext_id', 1, '', '', '', '', '', '', '', '', 1, 0);
INSERT INTO `admin_tablas` VALUES (107, 'tramite_pasos', 'pxt_uxt_id', 0, 'select', 'unidad_tiempo', 'uxt_id', 'uxt_nombre', '', 'uxt_estado', '', 'Unidad de Tiempo', 1, 0);
INSERT INTO `admin_tablas` VALUES (106, 'tramite_pasos', 'pxt_tmpolimite', 0, 'numero', '', '', '', '', '', '', 'Plazo máximo (Solo números)', 1, 0);
INSERT INTO `admin_tablas` VALUES (105, 'tramite_pasos', 'pxt_descripcion', 0, 'textareas', '', '', '', '', '', '', 'Descripción Trámite', 1, 0);
INSERT INTO `admin_tablas` VALUES (103, 'tramite_pasos', 'pxt_txp_id', 0, 'select', 'tramite_prefijo', 'txp_id', 'txp_nombre', '', 'txp_estado', '', 'Tiempo para realizar Trámite', 1, 0);
INSERT INTO `admin_tablas` VALUES (102, 'tramite_pasos', 'pxt_nombre', 0, 'text', '', '', '', '', '', 'SI', 'Nombre Etapa del Trámite', 1, 0);
...
INSERT INTO `admin_tablas` VALUES (99, 'tramite_tipo', 'txt_nombre', 0, 'text', '', '', '', '', '', 'SI', 'Nombre Tipo Trámite', 1, 0);
...
INSERT INTO `admin_tablas` VALUES (96, 'empresa_sedes', 'sede_nombre', 0, 'text', '', '', '', '', '', 'SI', 'Nombre Sede', 1, 0);
...
INSERT INTO `admin_tablas` VALUES (93, 'empresa_cliente', 'exc_gru_id', 0, 'select', 'empresas_grupo ', 'gru_id', 'gru_nombre', '', 'gru_estado', '', 'Grupo Empresas Cliente', 1, 0);
INSERT INTO `admin_tablas` VALUES (92, 'empresa_cliente', 'exc_nombre', 0, 'text', '', '', '', '', '', 'SI', 'Nombre Empresa Cliente', 1, 0);
INSERT INTO `admin_tablas` VALUES (91, 'empresa_cliente', 'exc_txe_id', 0, 'select', 'tipo_empresacliente', 'txe_id', 'txe_nombre', '', 'txe_estado', 'SI', 'Tipo Empresa', 1, 0);
INSERT INTO `admin_tablas` VALUES (90, 'empresa_cliente', 'exc_id', 1, '', '', '', '', '', '', '', '', 1, 0);
...
INSERT INTO `admin_tablas` VALUES (127, 'empresa_cliente', 'exc_res_id', 0, 'cargos', '', '', '', '', '', '', 'Responsable Alianza', 1, 0);
...
INSERT INTO `admin_tablas` VALUES (114, 'tipo_documento', 'txd_nombre', 0, 'text', '', '', '', '', '', 'SI', 'Nombre Tipo Documento', 1, 0);
...
INSERT INTO `admin_tablas` VALUES (88, 'tipo_empresacliente', 'txe_nombre', 0, 'text', '', '', '', '', '', 'SI', 'Nombre Tipo Empresa', 1, 0);
INSERT INTO `admin_tablas` VALUES (87, 'tipo_empresacliente', 'txe_id', 1, '', '', '', '', '', '', '', '', 1, 0);
INSERT INTO `admin_tablas` VALUES (77, 'dep_empresa', 'dxe_nombre', 0, 'text', '', '', '', '', '', 'SI', 'Nombre Departamento', 1, 0);
INSERT INTO `admin_tablas` VALUES (1, 'empresa', 'emp_id', 1, '', '', '', '', '', '', '', '', 1, 0);
INSERT INTO `admin_tablas` VALUES (2, 'empresa', 'emp_nombre', 0, 'text', '', '', '', '', '', 'SI', 'Nombre Empresa', 1, 0);
INSERT INTO `admin_tablas` VALUES (124, 'empresa_cliente', 'exc_mail', 0, 'email', '', '', '', '', '', '', 'E.mail contacto', 1, 0);
...
INSERT INTO `admin_tablas` VALUES (129, 'empresas_grupo', 'gru_nombre', 0, 'text', '', '', '', '', '', 'SI', 'Nombre Grupo', 1, 0);
...
INSERT INTO `admin_tablas` VALUES (132, 'tramite_frecuencia', 'txf_nombre', 0, 'text', '', '', '', '', '', 'SI', 'Nombre frecuencia', 1, 0);
INSERT INTO `admin_tablas` VALUES (133, 'tramite_frecuencia', 'txf_dias', 0, 'numero', '', '', '', '', '', '', 'Tiempo en Dias', 1, 0);
...
INSERT INTO `admin_tablas` VALUES (141, 'dep_empresa', 'dxe_siglas', 0, 'text', '', '', '', '', '', '', 'Siglas Departamento', 1, 0);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Cargos en el departamento de la empresa' AUTO_INCREMENT=24 ;

-- 
-- Volcar la base de datos para la tabla `cargos`
-- 

INSERT INTO `cargos` VALUES (1, '', 1, 4, 'Auxiliar cocoblue', 0, 'asi es la vida', 1, '2012-07-08 23:26:53', 1);
INSERT INTO `cargos` VALUES (2, 'MILE-PC', 1, 1, 'Administrativito', 0, 'un auto rojo', 1, '2012-07-08 22:39:59', 1);
INSERT INTO `cargos` VALUES (3, 'MILE-PC', 1, 1, 'modelo', 0, 'uhuhuhuhu', 1, '2012-07-03 00:10:28', 1);
INSERT INTO `cargos` VALUES (4, 'MILE-PC', 1, 1, 'agente', 0, 'Prioridad', 1, '2012-07-08 22:41:09', 1);
INSERT INTO `cargos` VALUES (5, 'MILE-PC', 1, 1, 'fiscal', 0, 'uhuhuhuhu', 1, '2012-07-03 00:14:18', 1);
INSERT INTO `cargos` VALUES (6, 'MILE-PC', 1, 5, 'contabilista', 0, 'fiscal al cargo contabilidad', 1, '2012-07-08 21:57:54', 1);
INSERT INTO `cargos` VALUES (7, 'MILE-PC', 1, 6, 'india', 0, 'contabiista revisa a india', 1, '2012-07-08 22:28:05', 1);
INSERT INTO `cargos` VALUES (8, 'MILE-PC', 1, 2, 'corazon', 0, 'cargo lider administrativitouh', 1, '2012-07-08 23:32:58', 1);
INSERT INTO `cargos` VALUES (9, '', 1, 1, 'no se acabe', 0, 'No se pierde un recuerdo te quiero', 1, '2012-07-08 23:38:12', 1);
INSERT INTO `cargos` VALUES (10, 'MILE-PC', 2, 7, 'asesor cial', 0, 'india a asesor cial', 1, '2012-07-08 22:39:44', 1);
INSERT INTO `cargos` VALUES (11, 'MILE-PC', 1, 2, 'perdida', 0, 'administrativito', 1, '2012-07-08 22:44:09', 1);
INSERT INTO `cargos` VALUES (12, 'MILE-PC', 1, 6, 'urge', 0, 'algo', 1, '2012-07-08 22:58:04', 1);
INSERT INTO `cargos` VALUES (13, 'MILE-PC', 1, 6, 'urge', 0, 'algo', 1, '2012-07-08 22:59:17', 1);
INSERT INTO `cargos` VALUES (14, 'MILE-PC', 1, 6, 'urge', 0, 'algo', 1, '2012-07-08 22:59:47', 1);
INSERT INTO `cargos` VALUES (15, 'MILE-PC', 1, 6, 'urge', 0, 'algo', 1, '2012-07-08 23:01:44', 1);
INSERT INTO `cargos` VALUES (16, 'MILE-PC', 1, 6, 'la vida', 0, 'jijiji', 1, '2012-07-08 23:02:28', 1);
INSERT INTO `cargos` VALUES (17, 'MILE-PC', 1, 6, 'la vida', 0, 'jijiji', 1, '2012-07-08 23:03:30', 1);
INSERT INTO `cargos` VALUES (18, 'MILE-PC', 1, 6, 'la vida', 0, 'jijiji', 1, '2012-07-08 23:04:32', 1);
INSERT INTO `cargos` VALUES (19, 'MILE-PC', 1, 6, 'la vida', 0, 'jijiji', 1, '2012-07-08 23:07:08', 1);
INSERT INTO `cargos` VALUES (20, 'MILE-PC', 1, 3, 'gugu', 0, 'jijiji', 1, '2012-07-08 23:08:23', 1);
INSERT INTO `cargos` VALUES (21, 'MILE-PC', 1, 3, 'gugu', 0, 'jijiji', 1, '2012-07-08 23:08:57', 1);
INSERT INTO `cargos` VALUES (22, 'MILE-PC', 1, 19, 'kii', 0, 'eso', 1, '2012-07-08 23:09:43', 1);
INSERT INTO `cargos` VALUES (23, '', 6, 0, 'Gerente PPAL', 0, 'Gerente el mÃ¡ximo lider de ip', 1, '2012-07-10 18:16:12', 1);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Departamentos de la Empresa' AUTO_INCREMENT=7 ;

-- 
-- Volcar la base de datos para la tabla `dep_empresa`
-- 

INSERT INTO `dep_empresa` VALUES (1, 1, 1, 'Contabilidad dos ', 'CON', 'Ingresos y Egresos de una mujer independiente calzonuda gallona decirle aceptar perfecta', 1, '2012-06-29 00:17:33', 1, '');
INSERT INTO `dep_empresa` VALUES (2, 1, 1, 'Comercial', 'COM', 'es victor rodriguez busca otro amor sobre el agua reflejo', 1, '2012-06-27 17:01:14', 1, 'MILE-PC');
INSERT INTO `dep_empresa` VALUES (3, 1, 2, 'Desarrollo', 'DES', 'Ventas y otras cosas', 1, '2012-06-29 20:15:01', 1, 'MILE-PC');
INSERT INTO `dep_empresa` VALUES (4, 2, 1, 'Contabilidad', 'CONN', 'Ingresos y Egresos de una mujer independiente calzonuda gallona decirle aceptar perfecta', 1, '2012-06-29 00:17:33', 1, '');
INSERT INTO `dep_empresa` VALUES (5, 2, 1, 'Recurso Humano', 'COMM', 'es victor rodriguez busca otro amor sobre el agua reflejo', 1, '2012-06-27 17:01:14', 1, 'MILE-PC');
INSERT INTO `dep_empresa` VALUES (6, 4, 0, 'Gerencia', 'GER', 'El gerente mas guapo y bello', 1, '2012-07-10 18:17:01', 1, '');
...
CREATE TABLE `empresa` (
  ...
  PRIMARY KEY  (`emp_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Empresas base' AUTO_INCREMENT=4 ;

-- 
-- Volcar la base de datos para la tabla `empresa`
-- 

INSERT INTO `empresa` VALUES (1, 'Empresa de EDDO', '88995511', 'cra 15 39 39', '7878787', '', 1, '2012-07-09 09:12:29', 1, 'MILE-PC');
INSERT INTO `empresa` VALUES (2, 'empresa segunda fuerte de eddo', '8787879091', '', '', '', 1, '2012-06-27 17:00:18', 1, 'MILE-PC');
INSERT INTO `empresa` VALUES (3, 'Empresa MasterKHL', '789', 'calle 116 19', '6547877', 'Era la empresa de Karl Loeber', 1, '2012-07-10 18:14:24', 1, 'MILE-PC');
...
INSERT INTO `empresas_grupo` VALUES (1, 'Grande', 'Grupo Grande de Empresas Cliente', 1, '2012-07-04 14:01:00', 1, 'MILE-PC');
INSERT INTO `empresas_grupo` VALUES (2, 'PEQUEÃ‘A', '', 1, '2012-07-10 20:54:22', 1, 'MILE-PC');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Empresas Cliente' AUTO_INCREMENT=11 ;
...
INSERT INTO `empresa_cliente` VALUES (2, '2012-07-08 20:54:45', 1, 1, 1, 'emp dos', '9999999', 'calle 118 no 43 57', 7896543, 3157889, '', 'Maria Perez', 'maria@perz.com', 3, 1, 'MILE-PC');
INSERT INTO `empresa_cliente` VALUES (3, '2012-07-10 11:31:37', 1, 3, 1, 'ARP Milenita', '90007878', 'cra 20', 898989, 898989, '', 'miller', 'mil@mail.com', 8, 1, 'MILE-PC');
INSERT INTO `empresa_cliente` VALUES (4, '2012-07-10 11:45:43', 1, 2, 3, 'Nva Eps', '890', 'Cra 12  45 67', 8989, 314567, '', 'jorge', 'lol@mail.com', 1, 1, 'MILE-PC');
INSERT INTO `empresa_cliente` VALUES (5, '2012-07-10 11:56:19', 1, 2, 3, 'Nva Eps', '890', 'Cra 12  45 67', 8989, 314567, '', 'jorge', 'lol@mail.com', 1, 1, 'MILE-PC');
INSERT INTO `empresa_cliente` VALUES (6, '2012-07-10 12:39:46', 1, 3, 1, 'ARP marinita', '787878', 'Kra 56 ', 8989, 7878, '', 'Marina', 'milr@mail.com', 2, 1, 'MILE-PC');
INSERT INTO `empresa_cliente` VALUES (7, '2012-07-10 12:48:18', 1, 3, 3, 'huuhh', '9999', 'dc', 8989, 314567, '', 'jorge', 'mil@mail.com', 18, 1, 'MILE-PC');
INSERT INTO `empresa_cliente` VALUES (8, '2012-07-10 13:10:52', 1, 3, 3, 'huuhh', '9999', 'dc', 8989, 314567, '', 'jorge', 'mil@mail.com', 18, 1, 'MILE-PC');
INSERT INTO `empresa_cliente` VALUES (9, '2012-07-10 13:13:20', 1, 3, 2, 'arp lala', '5454', 'kra54', 97979, 79797979, '', 'semillita', 'mil@mail.com', 7, 1, 'MILE-PC');
INSERT INTO `empresa_cliente` VALUES (10, '2012-07-10 13:30:40', 1, 3, 2, 'arp lala', '5454', 'kra54', 97979, 79797979, '', 'semillita', 'mil@mail.com', 7, 1, 'MILE-PC');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Sedes de la Empresas Base' AUTO_INCREMENT=5 ;

-- 
-- Volcar la base de datos para la tabla `empresa_sedes`
-- 

INSERT INTO `empresa_sedes` VALUES (1, 1, 'Principalita', 'es una descripcion de la sede ppalita', 1, '2012-07-10 18:25:42', 1, '');
INSERT INTO `empresa_sedes` VALUES (2, 1, 'central', '', 1, '2012-06-29 19:56:57', 1, 'MILE-PC');
INSERT INTO `empresa_sedes` VALUES (3, 1, 'central oriente', '', 1, '2012-06-29 19:51:33', 1, '');
INSERT INTO `empresa_sedes` VALUES (4, 3, 'Polo', 'Es donde hay una casa y el carro plateado de karl heinzmkmk', 1, '2012-07-10 18:39:14', 1, '');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Tabla base de los tramites' AUTO_INCREMENT=1 ;
...
INSERT INTO `tramite_frecuencia` VALUES (1, 'Diario', 1, '2012-07-08 18:58:02', 1, 'MILE-PC', 1);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Pasos de los Tipo_Tramites' AUTO_INCREMENT=1 ;
...
INSERT INTO `tramite_tipo` VALUES (6, 1, 'ACTA REUNION EXTERNA', '2012-12-12', '2012-01-01', '', 1, '0000-00-00 00:00:00', 0, '');
...
INSERT INTO `tramite_tipo` VALUES (25, 2, 'AAANew tramite', '2012-07-10', '2012-09-20', 'Es una cosita nueva', 1, '2012-07-09 22:49:36', 1, 'MILE-PC');
INSERT INTO `tramite_tipo` VALUES (26, 2, 'AAANew tramite', '2012-07-10', '2012-09-20', 'Es una cosita nueva', 1, '2012-07-09 22:51:07', 1, 'MILE-PC');
INSERT INTO `tramite_tipo` VALUES (27, 1, 'AAAnut', '2012-07-09', '2012-07-17', 'vghhjj', 1, '2012-07-10 13:31:15', 1, 'MILE-PC');
INSERT INTO `tramite_tipo` VALUES (28, 1, 'aatramitomania dos', '2012-07-03', '2012-07-18', 'es una adiccion', 1, '2012-07-10 15:44:03', 1, 'MILE-PC');
...
INSERT INTO `tramite_tipo_origen` VALUES (1, 'Interno', 'Se refiere a un trÃ¡mite en la propia empresa', 1, '2012-06-29 23:53:56', 1, 'MILE-PC');
INSERT INTO `tramite_tipo_origen` VALUES (2, 'Externa', 'Se refiere a que el trÃ¡mite es para o desde unaempresa cliente', 1, '2012-06-29 23:53:01', 1, 'MILE-PC');
...
INSERT INTO `usuario` VALUES (1, '1', 1, '2012-04-18 18:51:04', 1, 1, 1, 1, 'Milena de la Rosa', '', 0, 'mile', 'ea08e678edbf8892b8d67fc36f4a3bf9', 'milenaamaya@gmail.com', 'milenita@mail.com', '0', 0, '', 1, '');
INSERT INTO `usuario` VALUES (2, '1', 1, '2012-04-18 18:51:04', 1, 1, 1, 1, 'mauricio de la Rosa', '', 0, 'mau', 'ea08e678edbf8892b8d67fc36f4a3bf9', 'milenaamaya@gmail.com', 'milenita@mail.com', '0', 0, '', 1, '');
INSERT INTO `usuario` VALUES (3, '1', 1, '2012-04-18 18:51:04', 1, 1, 1, 1, 'aliciade la Rosa', '', 0, 'ali', 'ea08e678edbf8892b8d67fc36f4a3bf9', 'milenaamaya@gmail.com', 'milenita@mail.com', '0', 0, '', 1, '');
...
-- 
-- Estructura Stand-in para la vista `v_empdepto`
-- 
CREATE TABLE `v_empdepto` (
`dxe_id` int(11)
,`dxe_nombre` varchar(353)
);
-- --------------------------------------------------------
...
-- 
-- Estructura para la vista `v_empdepto`
-- 
DROP TABLE IF EXISTS `v_empdepto`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `tramites`.`v_empdepto` AS select `a`.`dxe_id` AS `dxe_id`,concat(`b`.`emp_nombre`,_utf8' - ',`a`.`dxe_nombre`) AS `dxe_nombre` from (`tramites`.`dep_empresa` `a` join `tramites`.`empresa` `b` on((`a`.`dxe_emp_id` = `b`.`emp_id`))) where ((`a`.`dxe_estado` = 1) and (`b`.`emp_estado` = 1)) order by `b`.`emp_nombre`,`a`.`dxe_nombre`;
