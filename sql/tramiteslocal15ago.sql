...
-- 
-- Servidor: localhost
-- Tiempo de generación: 15-08-2012 a las 14:15:07
...
CREATE TABLE `admin_permisos` (
  ...
  PRIMARY KEY  (`aper_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=90 ;
...
INSERT INTO `admin_tablas` VALUES (98, 'tramite_tipo', 'txt_id', 1, '', '', '', '', '', '', '', '', 1, 0, 'txt_nombre');
...
INSERT INTO `admin_tablas` VALUES (79, 'cargos', 'car_id', 1, '', '', '', '', '', '', '', '', 1, 0, 'car_dxe_id,car_nombre');
...
INSERT INTO `admin_tablas` VALUES (169, 'empresa_cliente', 'exc_id', 1, '', '', '', '', '', '', '', '', 1, 0, 'exc_exg_id,tipo_empresacliente.txe_nombre,empresa_cliente.exc_nombre');
...
INSERT INTO `admin_tablas` VALUES (162, 'alianza_dep', 'axe_nombre', 0, 'required', '', '', '', '', '', 'SI', 'Nombre Dpto Empresa Grupo Alianza', 1, 0, '');
INSERT INTO `admin_tablas` VALUES (163, 'alianza_dep', 'axe_siglas', 0, 'required', '', '', '', '', '', '', 'Siglas Dep Empresa Alianza', 1, 0, '');
...
INSERT INTO `admin_tablas` VALUES (181, 'tramite_tipo', 'txt_tmaximo', 0, 'numeror', '', '', '', '', '', '', 'Tiempo Máximo del trámite', 1, 0, '');
...
INSERT INTO `cargos` VALUES (4, '', 1, 0, 'cargo 4', 0, '', 1, '2012-08-08 00:19:45', 1);
...
INSERT INTO `departamento` VALUES (1, 'MILE-PC', 'Amazonas', 'El Amazonas es la regION selvAtica tropical mAs grande del planeta, con una extensiOn aproximada de 6.000.000 km2 repartidos en ocho paÃƒÂ­ses de SuramÃƒÂ©rica: Brasil, PerÃƒÂº (estos dos paÃƒÂ­ses los que mayor extensiÃƒÂ³n selvÃƒÂ¡tiva poseen), Colombia, Bolivia, Venezuela, Ecuador, Guyana y Guayana Francesa.', 1, '2012-08-12 15:06:05', 1);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Departamentos de la Empresa' AUTO_INCREMENT=6 ;
...
INSERT INTO `dep_empresa` VALUES (5, 3, 'Departamento Contabilidad', 'es el departamento para contar egresos e ingresos', 1, '2012-08-12 20:49:38', 1, 'MILE-PC');
...
INSERT INTO `empresas_grupo` VALUES (3, 'MAS DE 300 TRABAJADORES', '', 1, '0000-00-00 00:00:00', 0, '');
...
INSERT INTO `empresas_tipo` VALUES (1, 'Contratistas', 'Un contratista es la persona o empresa que es contratada por otra organización o particular para la construcción de un edificio, carretera, instalación o algún trabajo especial, como refinerías o plataformas petroleras.', 0, '2012-08-15 10:31:04', '', '');
INSERT INTO `empresas_tipo` VALUES (2, 'Proveedores', 'Se aplica a la persona natural o empresa que se dedica a proveer o abastecer de productos o servicios necesarios a una persona o empresa', 0, '2012-08-15 10:31:04', '', '');
INSERT INTO `empresas_tipo` VALUES (3, 'Entidades Estatales', 'Son todas aquellas entidades que son propiedad del Estado, sea éste nacional, municipal o de cualquier otro estrato administrativo, ya sea de un modo total o parcial', 0, '2012-08-15 10:34:27', '', '');
INSERT INTO `empresas_tipo` VALUES (4, 'Clientes', 'Cliente es quien accede a un producto o servicio que ofrece el Grupo Alianza por medio de una transacción financiera (dinero) u otro medio de pago.', 0, '2012-08-15 10:37:26', '', '');
...
INSERT INTO `empresa_cliente` VALUES (1, 2, '2012-07-28 00:00:15', 1, 3, 1, 'ARP Milenita Amaya de la Rosa', '654390', 'cra 28 calle 53', 6898284, 2147483647, '', 'Milena Martinez de la Rosa', 'mil@mail.com', 4, 0, 'MILE-PC');
...
INSERT INTO `empresa_cliente` VALUES (8, 1, '2012-08-12 23:01:29', 1, 3, 3, 'ARP Eddo', '787878', 'cra 28 calle 53', 6898284, 898989, '', 'miller', 'milr@mail.com', 3, 1, '');
...
INSERT INTO `empresa_sedes` VALUES (3, 1, 'Empresa Cooperativa de Empleo', '', 1, '2012-08-12 21:48:23', 1, '');
...
INSERT INTO `tipo_empresacliente` VALUES (16, 'empresa aries', '', 1, '2012-08-09 15:13:51', 1, 'MILE-PC');
...
CREATE TABLE `tramite_frecuencia` (
  ...
  PRIMARY KEY  (`txf_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Frecuencia de los tramites en dias' AUTO_INCREMENT=6 ;
...
INSERT INTO `tramite_frecuencia` VALUES (5, 'N/A', 0, '2012-08-12 15:31:32', 1, '', 1);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Pasos de los Tipo_Tramites' AUTO_INCREMENT=11 ;
...
INSERT INTO `tramite_pasos` VALUES (6, 6, 1, 3, 'tres', 'jkjjk', 2, 1, 0, '2012-08-07 00:16:41', 1, '', '');
INSERT INTO `tramite_pasos` VALUES (7, 17, 1, 3, 'hhuuuhueditado', 'vfgfftft', 7, 1, 1, '2012-08-08 23:14:47', 1, '', '');
INSERT INTO `tramite_pasos` VALUES (8, 17, 2, 3, 'dos', 'nadita', 8, 1, 1, '2012-08-08 20:48:08', 1, 'MILE-PC', '');
INSERT INTO `tramite_pasos` VALUES (9, 17, 2, 3, 'dos', 'nadita', 8, 1, 1, '2012-08-08 20:49:09', 1, 'MILE-PC', '');
INSERT INTO `tramite_pasos` VALUES (10, 17, 1, 3, 'tres paso', 'uihhuhu', 7, 1, 1, '2012-08-08 20:52:29', 1, 'MILE-PC', '');
...
INSERT INTO `tramite_tipo` VALUES (4, 1, 'REQUERIMIENTO RECIBIDO', '2012-12-12', '2012-01-01', '', 0, 0, 0, '0000-00-00 00:00:00', 0, '', '');
...
INSERT INTO `tramite_tipo` VALUES (9, 1, 'TRIBUTARIA ENVIADA', '2012-12-12', '2012-01-01', '', 0, 0, 0, '0000-00-00 00:00:00', 0, '', '');
INSERT INTO `tramite_tipo` VALUES (10, 1, 'TRIBUTARIA RECIBIDA', '2012-12-12', '2012-01-01', '', 0, 0, 0, '0000-00-00 00:00:00', 0, '', '');
...
INSERT INTO `tramite_tipo` VALUES (17, 3, 'AAAnut', '2012-07-03', '2012-08-05', 'jijij es una prueba de edicion', 7, 1, 1, '2012-08-08 23:13:48', 1, 'MILE-PC', '');
INSERT INTO `tramite_tipo` VALUES (18, 4, 'aNEWEDDO', '2012-08-07', '2012-08-21', 'hfftftftfttft', 9, 1, 1, '2012-08-08 20:53:25', 1, 'MILE-PC', '');
INSERT INTO `tramite_tipo` VALUES (19, 1, 'kokoo', '2012-08-14', '2012-08-21', 'hiuy7t7ygh', 8, 1, 1, '2012-08-08 22:05:43', 1, 'MILE-PC', '');
...
INSERT INTO `usuario` VALUES (4, '1', 1, '2012-08-07 11:13:31', 0, 9, 2, 'EDUARDO', 'GRANADA ', 'EDUARDO GRANADA', 79495447, 'ed_granada', 'b0347545609b4e5e3233acf9f3d9cd06', 'aaamm@ala.com', 'aaamm@ala.com', 'ASDFAD', 'ASDF', 0, '', 1, '');
...
CREATE TABLE `usu_log` (
  ...
  PRIMARY KEY  (`uxl_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Tabla Verifica Usuario Activo' AUTO_INCREMENT=2 ;
