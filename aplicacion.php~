...
<body onload="if(document.frm.txt_quin2.value==0) document.frm.txt_quin2.value='';if(document.frm.txt_quin1.value==0) document.frm.txt_quin1.value='';" onunload>
<div id="cuerpo_int">
...
<?php 
  ...
  { //Nuevos Usuarios
     ...
     if($_POST['v_usua']>0)
	     $_POST['usu_car_lider'] = $_POST['v_usua'];#Guarda el id de usuario lider
...
<?php
 if($n==52)
 { //Editar Usuarios
     $_POST['usu_car_id'] = $_POST['usu_carr_id'];
     $campos = "usu_nombre|S,usu_apel|S,usu_corto|S,usu_cedula|S,usu_car_id|N,usu_emailcor|S,usu_emailper|S,usu_fijo|S,";
