...
<? $nombre_campos_tabla .= "txt_txf_id|N,";?>  
  ...
  <td><!--<table width="590" border="0">
    <tr>
      ...
      <td><?=$Gen->ComboBox("SELECT sede_id,sede_nombre FROM ".$t_empresa_sedes." ORDER BY sede_nombre;", sede_id,sede_nombre,txt_sede)?></td>
    </tr>
    <tr>
    <tr>
      <td><label>Departamento</label></td>
      <td><select name="txt_dxe_id" id="txt_dxe_id" required><option selected value="0">SELECCIONE</option>
		  </select></td>
    </tr>
   <? //$nombre_campos_tabla .= "txt_dxe_id|N,";?>
  </table>--></td>
  </tr>
