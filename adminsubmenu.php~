...
<input type="text" name="busqueda" required value="<? if(isset($_POST['busqueda'])) echo $_POST['busqueda']?>"><input type="submit" class="bot" value="Buscar">
