...
-- 
-- Servidor: localhost
-- Tiempo de generación: 01-08-2012 a las 16:58:26
...
INSERT INTO `admin_menu` VALUES (23, 'empresa_sedes', 'Sedes Grupo Empresarial', 'Sedes del Grupo Alianza', 'dep_empresa', 'dxe_sede_id', 'sede_estado', 'sede_usu_id', 'sede_fechahora', 'sede_equipo', 0);
...
INSERT INTO `admin_menu` VALUES (17, 'dep_empresa', 'Departamentos Grupo', 'Departamentos de las empresas propias', 'cargos', 'car_dxe_id', 'dxe_estado', 'dxe_usu_id', 'dxe_fechahora', 'dxe_equipo', 0);
...
INSERT INTO `admin_menu` VALUES (33, 'alianza_emp', 'Empresas  Alianza', 'Son las Empresas del grupo Alianza para el manejo de tramites.', 'alianza_sedes', 'axs_exa_id', 'exa_estado', 'exa_usu_id', 'exa_fechahora', 'exa_equipo', 0);
INSERT INTO `admin_menu` VALUES (34, 'alianza_sedes', 'Sedes Empresas Alianza', 'Sedes de las Empresas del Grupo Alianza para el manejo de tramites', 'alianza_dep', 'axe_axs_id', 'axs_estado', 'axs_usu_id', 'axs_fechahora', 'axs_equipo', 0);
INSERT INTO `admin_menu` VALUES (35, 'depxdepal', 'Configuracion Departamentos', 'Configuración Departamentos Grupo Alianza con Depatamentos Recepción Empresas Alianza para manejo de trámites', '', '', 'dxd_estado', 'dxd_usu_id', 'dxd_fechahora', 'dxd_equipo', 0);
INSERT INTO `admin_menu` VALUES (36, 'alianza_dep', 'Departamentos Empresas Alianza', 'Son los Departamentos de las Empresas de Alianza', '', '', 'axe_estado', 'axe_usu_id', 'axe_fechahora', 'axe_equipo', 0);
...
CREATE TABLE `admin_tablas` (
  ...
  PRIMARY KEY  (`axt_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=165 ;
...
INSERT INTO `alianza_dep` VALUES (1, 1, 'Depto sede1', '', 'hhhuuhuhu', 1, '2012-07-27 09:08:03', 1, '');
...
CREATE TABLE `usu_log` (
  ...
  PRIMARY KEY  (`uxl_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Tabla Verifica Usuario Activo' AUTO_INCREMENT=50 ;
...
INSERT INTO `usu_log` VALUES (46, 1, '1', 'Ingreso al SCTS', 'SRVCONTABILIDAD', '2012-08-01 08:58:42');
INSERT INTO `usu_log` VALUES (47, 1, '1', 'Ingreso al SCTS', 'SRVCONTABILIDAD', '2012-08-01 09:11:32');
INSERT INTO `usu_log` VALUES (48, 1, '1', 'Borrar Usuarios', 'SRVCONTABILIDAD', '2012-08-01 09:12:19');
INSERT INTO `usu_log` VALUES (49, 1, '1', 'Ingreso al SCTS', 'SRVCONTABILIDAD', '2012-08-01 13:13:19');
