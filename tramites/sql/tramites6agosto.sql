...
-- 
-- Servidor: localhost
-- Tiempo de generación: 07-08-2012 a las 00:21:10
...
INSERT INTO `admin_tablas` VALUES (106, 'tramite_pasos', 'pxt_tmpolimite', 0, 'numeror', '', '', '', '', '', '', 'Plazo máximo (Solo números)', 1, 0);
...
INSERT INTO `admin_tablas` VALUES (181, 'tramite_tipo', 'txt_tmaximo', 0, 'text', '', '', '', '', '', '', 'Tiempo Máximo del trámite', 1, 0);
INSERT INTO `admin_tablas` VALUES (182, 'tramite_tipo', 'txt_uxt_id', 0, 'select', 'unidad_tiempo', 'uxt_id', 'uxt_nombre', '', 'uxt_estado', '', 'Unidad Tiempo', 1, 0);
...
CREATE TABLE `textos` (
  ...
  PRIMARY KEY  (`txt_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci AUTO_INCREMENT=23 ;
...
INSERT INTO `textos` VALUES (17, 'empresalianza', 'Seleccione para cual de las empresas está dirigido el trámite.', 1);
INSERT INTO `textos` VALUES (18, 'sedealianza', 'Para seleccionar Sede de la Empresa Alianza, primero debe seleccionar una Empresa.', 1);
INSERT INTO `textos` VALUES (19, 'deptoalianza', 'Para seleccionar un Departamento debe seleccionar una sede de la Empresa Alianza.', 1);
INSERT INTO `textos` VALUES (20, 'categoria', 'Se refiere al fin  u objetivo del trámite en cuestión.', 1);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Pasos de los Tipo_Tramites' AUTO_INCREMENT=7 ;

-- 
-- Volcar la base de datos para la tabla `tramite_pasos`
-- 

INSERT INTO `tramite_pasos` VALUES (1, 1, 1, 3, 'Primero paso', 'SEDE PRIMER PASO', 3, 1, 1, '2012-08-06 00:10:58', 1, '', '');
INSERT INTO `tramite_pasos` VALUES (2, 6, 1, 3, 'Segundo', 'bhbhuhu hbuhuuh', 1, 1, 1, '2012-08-05 23:13:01', 1, 'MILE-PC', '');
INSERT INTO `tramite_pasos` VALUES (3, 1, 1, 3, 'segundo paso', 'Es el segundo paso', 1, 1, 1, '2012-08-06 21:21:15', 1, 'MILE-PC', '');
INSERT INTO `tramite_pasos` VALUES (4, 1, 1, 8, 'tercero', 'cargo 8 responsable', 2, 1, 1, '2012-08-06 22:15:10', 1, 'MILE-PC', '');
INSERT INTO `tramite_pasos` VALUES (5, 1, 1, 8, 'tercero', 'cargo 8 responsable', 6, 1, 1, '2012-08-06 23:19:58', 1, '', '');
INSERT INTO `tramite_pasos` VALUES (6, 6, 1, 3, 'tres', 'jkjjk', 2, 1, 1, '2012-08-07 00:16:41', 1, '', '');
...
INSERT INTO `tramite_tipo` VALUES (1, 1, 'COMUNICADO ENVIADO', '2012-12-12', '2012-01-01', 'Informacion oficial escrita y autorizada que se facilita a las personas como resumen de una reunion o hechos de interes general.oo', 5, 1, 1, '2012-08-05 22:43:52', 1, 'MILE-PC');
INSERT INTO `tramite_tipo` VALUES (2, 1, 'COMUNICADO  RECIBIDO', '2012-12-12', '2012-01-01', '', 0, 0, 1, '0000-00-00 00:00:00', 0, '');
INSERT INTO `tramite_tipo` VALUES (3, 1, 'REQUERIMIENTO ENVIADO', '2012-12-12', '2012-01-01', '', 0, 0, 1, '0000-00-00 00:00:00', 0, '');
INSERT INTO `tramite_tipo` VALUES (4, 1, 'REQUERIMIENTO RECIBIDO', '2012-12-12', '2012-01-01', '', 0, 0, 1, '0000-00-00 00:00:00', 0, '');
INSERT INTO `tramite_tipo` VALUES (5, 1, 'ACTA REUNION INTERNA', '2012-12-12', '2012-01-01', '', 0, 0, 1, '0000-00-00 00:00:00', 0, '');
INSERT INTO `tramite_tipo` VALUES (6, 1, 'ACTA REUNION EXTERNA', '2012-09-01', '2013-09-01', 'Un aÃ±o', 5, 1, 1, '2012-08-06 00:10:40', 1, 'MILE-PC');
INSERT INTO `tramite_tipo` VALUES (7, 1, 'JURIDICA ENVIADA', '2012-12-12', '2012-01-01', '', 0, 0, 1, '0000-00-00 00:00:00', 0, '');
INSERT INTO `tramite_tipo` VALUES (8, 1, 'JURIDICA RECIBIDA', '2012-12-12', '2012-01-01', '', 0, 0, 1, '0000-00-00 00:00:00', 0, '');
INSERT INTO `tramite_tipo` VALUES (9, 1, 'TRIBUTARIA ENVIADA', '2012-12-12', '2012-01-01', '', 0, 0, 1, '0000-00-00 00:00:00', 0, '');
INSERT INTO `tramite_tipo` VALUES (10, 1, 'TRIBUTARIA RECIBIDA', '2012-12-12', '2012-01-01', '', 0, 0, 1, '0000-00-00 00:00:00', 0, '');
INSERT INTO `tramite_tipo` VALUES (11, 1, 'COBRO CLIENTE', '2012-12-12', '2012-01-01', '', 0, 0, 1, '0000-00-00 00:00:00', 0, '');
INSERT INTO `tramite_tipo` VALUES (12, 1, 'COBRO PROVEEDOR', '2012-12-12', '2012-01-01', '', 0, 0, 1, '0000-00-00 00:00:00', 0, '');
INSERT INTO `tramite_tipo` VALUES (13, 1, 'QUEJA INTERNA', '2012-12-12', '2012-01-01', '', 0, 0, 1, '0000-00-00 00:00:00', 0, '');
INSERT INTO `tramite_tipo` VALUES (14, 1, 'QUEJA EXTERNA EMPL. MISION', '2012-12-12', '2012-01-01', '', 0, 0, 1, '0000-00-00 00:00:00', 0, '');
INSERT INTO `tramite_tipo` VALUES (15, 1, 'QUEJA EXTERNA EMPRESA USUARIA', '2012-12-12', '2012-01-01', '', 0, 0, 1, '0000-00-00 00:00:00', 0, '');
INSERT INTO `tramite_tipo` VALUES (16, 1, 'QUEJA CLIENTE CONSTRUCCION', '2012-12-12', '2012-01-01', '', 0, 0, 1, '0000-00-00 00:00:00', 0, '');
...
CREATE TABLE `usu_log` (
  ...
  PRIMARY KEY  (`uxl_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Tabla Verifica Usuario Activo' AUTO_INCREMENT=140 ;
...
INSERT INTO `usu_log` VALUES (92, 1, '', 'Ingreso al SCTS', 'MILE-PC', '2012-08-04 08:34:03');
INSERT INTO `usu_log` VALUES (93, 1, '', 'Ingreso al SCTS', 'MILE-PC', '2012-08-04 11:12:45');
INSERT INTO `usu_log` VALUES (94, 1, '', 'Modifico tabla tramite_tipo', 'MILE-PC', '2012-08-04 11:20:16');
INSERT INTO `usu_log` VALUES (95, 1, '', 'Ingreso al SCTS', 'MILE-PC', '2012-08-05 16:51:59');
INSERT INTO `usu_log` VALUES (96, 1, '', 'Ingreso al SCTS', 'MILE-PC', '2012-08-05 17:34:17');
INSERT INTO `usu_log` VALUES (97, 1, '', 'Ingreso al SCTS', 'MILE-PC', '2012-08-05 17:41:39');
INSERT INTO `usu_log` VALUES (98, 1, '', 'Ingreso al SCTS', 'MILE-PC', '2012-08-05 18:48:59');
INSERT INTO `usu_log` VALUES (99, 1, '', 'Modifico tabla tramite_pasos', 'MILE-PC', '2012-08-05 18:50:33');
INSERT INTO `usu_log` VALUES (100, 1, '', 'Ingreso al SCTS', 'MILE-PC', '2012-08-05 19:40:43');
INSERT INTO `usu_log` VALUES (101, 1, '', 'Ingreso al SCTS', 'MILE-PC', '2012-08-05 21:32:23');
INSERT INTO `usu_log` VALUES (102, 1, '', 'Ingreso registro tabla tramite_pasos', 'MILE-PC', '2012-08-05 21:33:39');
INSERT INTO `usu_log` VALUES (103, 1, '', 'Ingreso registro tabla tramite_pasos', 'MILE-PC', '2012-08-05 21:39:43');
INSERT INTO `usu_log` VALUES (104, 1, '', 'Ingreso registro tabla tramite_pasos', 'MILE-PC', '2012-08-05 21:40:47');
INSERT INTO `usu_log` VALUES (105, 1, '', 'Modifico tabla tramite_pasos', 'MILE-PC', '2012-08-05 21:43:03');
INSERT INTO `usu_log` VALUES (106, 1, '', 'Modifico tabla tramite_pasos', 'MILE-PC', '2012-08-05 21:43:25');
INSERT INTO `usu_log` VALUES (107, 1, '', 'Modifico tabla tramite_tipo', 'MILE-PC', '2012-08-05 21:43:46');
INSERT INTO `usu_log` VALUES (108, 1, '', 'Modifico tabla tramite_tipo', 'MILE-PC', '2012-08-05 21:45:13');
INSERT INTO `usu_log` VALUES (109, 1, '', 'Ingreso al SCTS', 'MILE-PC', '2012-08-05 22:24:27');
INSERT INTO `usu_log` VALUES (110, 1, '', 'Ingreso al SCTS', 'MILE-PC', '2012-08-05 22:47:04');
INSERT INTO `usu_log` VALUES (111, 1, '', 'Modifico tabla tramite_pasos', 'MILE-PC', '2012-08-05 22:59:52');
INSERT INTO `usu_log` VALUES (112, 1, '', 'Ingreso registro tabla tramite_pasos', 'MILE-PC', '2012-08-05 23:00:52');
INSERT INTO `usu_log` VALUES (113, 1, '', 'Modifico tabla tramite_pasos', 'MILE-PC', '2012-08-05 23:01:12');
INSERT INTO `usu_log` VALUES (114, 1, '', 'Modifico tabla tramite_pasos', 'MILE-PC', '2012-08-05 23:01:28');
INSERT INTO `usu_log` VALUES (115, 1, '', 'Modifico tabla tramite_pasos', 'MILE-PC', '2012-08-05 23:01:47');
INSERT INTO `usu_log` VALUES (116, 1, '', 'Modifico tabla tramite_pasos', 'MILE-PC', '2012-08-05 23:02:11');
INSERT INTO `usu_log` VALUES (117, 1, '', 'Modifico tabla tramite_pasos', 'MILE-PC', '2012-08-05 23:07:30');
INSERT INTO `usu_log` VALUES (118, 1, '', 'Modifico tabla tramite_pasos', 'MILE-PC', '2012-08-05 23:08:04');
INSERT INTO `usu_log` VALUES (119, 1, '', 'Ingreso registro tabla tramite_pasos', 'MILE-PC', '2012-08-05 23:10:23');
INSERT INTO `usu_log` VALUES (120, 1, '', 'Modifico tabla tramite_tipo', 'MILE-PC', '2012-08-05 23:10:36');
INSERT INTO `usu_log` VALUES (121, 1, '', 'Modifico tabla tramite_tipo', 'MILE-PC', '2012-08-05 23:10:50');
INSERT INTO `usu_log` VALUES (122, 1, '', 'Modifico tabla tramite_pasos', 'MILE-PC', '2012-08-05 23:11:06');
INSERT INTO `usu_log` VALUES (123, 1, '', 'Ingreso registro tabla tramite_pasos', 'MILE-PC', '2012-08-05 23:13:01');
INSERT INTO `usu_log` VALUES (124, 1, '', 'Ingreso al SCTS', 'MILE-PC', '2012-08-06 21:02:19');
INSERT INTO `usu_log` VALUES (125, 1, '', 'Ingreso al SCTS', 'MILE-PC', '2012-08-06 21:18:58');
INSERT INTO `usu_log` VALUES (126, 1, '', 'Ingreso registro tabla tramite_pasos', 'MILE-PC', '2012-08-06 21:21:15');
INSERT INTO `usu_log` VALUES (127, 1, '', 'Ingreso al SCTS', 'MILE-PC', '2012-08-06 22:02:22');
INSERT INTO `usu_log` VALUES (128, 1, '', 'Ingreso registro tabla tramite_pasos', 'MILE-PC', '2012-08-06 22:15:10');
INSERT INTO `usu_log` VALUES (129, 1, '', 'Ingreso registro tabla tramite_pasos', 'MILE-PC', '2012-08-06 22:17:08');
INSERT INTO `usu_log` VALUES (130, 1, '', 'Ingreso registro tabla tramite_pasos', 'MILE-PC', '2012-08-06 22:17:58');
INSERT INTO `usu_log` VALUES (131, 1, '', 'Modifico tabla tramite_pasos', 'MILE-PC', '2012-08-06 22:23:11');
INSERT INTO `usu_log` VALUES (132, 1, '1', 'Ingreso al SCTS', 'MILE-PC', '2012-08-06 23:03:08');
INSERT INTO `usu_log` VALUES (133, 1, '1', 'Ingreso registro tabla tramite_pasos', 'MILE-PC', '2012-08-06 23:03:59');
INSERT INTO `usu_log` VALUES (134, 1, '1', 'Modifico tabla tramite_pasos', 'MILE-PC', '2012-08-06 23:05:25');
INSERT INTO `usu_log` VALUES (135, 1, '1', 'Modifico tabla tramite_pasos', 'MILE-PC', '2012-08-06 23:06:19');
INSERT INTO `usu_log` VALUES (136, 1, '1', 'Modifico tabla tramite_pasos', 'MILE-PC', '2012-08-06 23:13:24');
INSERT INTO `usu_log` VALUES (137, 1, '1', 'Modifico tabla tramite_pasos', 'MILE-PC', '2012-08-06 23:16:30');
INSERT INTO `usu_log` VALUES (138, 1, '1', 'Modifico tabla tramite_pasos', 'MILE-PC', '2012-08-06 23:16:50');
INSERT INTO `usu_log` VALUES (139, 1, '1', 'Modifico tabla tramite_pasos', 'MILE-PC', '2012-08-06 23:20:21');
