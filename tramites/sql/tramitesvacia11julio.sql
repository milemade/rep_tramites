...
-- 
-- Servidor: localhost
-- Tiempo de generación: 11-07-2012 a las 19:51:21
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Cargos en el departamento de la empresa' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Sedes de la Empresas Base' AUTO_INCREMENT=1 ;
...
DROP VIEW IF EXISTS `v_empdepto`;
