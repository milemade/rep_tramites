...
-- 
-- Servidor: localhost
-- Tiempo de generación: 01-08-2012 a las 06:24:12
...
INSERT INTO `admin_menu` VALUES (23, 'empresa_sedes', 'Sedes Empresa', 'Sedes del Grupo Alianza', 'dep_empresa', 'dxe_sede_id', 'sede_estado', 'sede_usu_id', 'sede_fechahora', 'sede_equipo', 0);
...
INSERT INTO `admin_menu` VALUES (1, 'empresa', 'Grupo Empresarial', 'Grupo Alianza', 'empresa_sedes', 'sede_emp_id', 'emp_estado', 'emp_usu_id', 'emp_fechahora', 'emp_equipo', 0);
INSERT INTO `admin_menu` VALUES (33, 'alianza_emp', 'Empresas Grupo Alianza', 'Son las Empresas del grupo Alianza', 'alianza_sedes', 'axs_exa_id', 'exa_estado', 'exa_usu_id', 'exa_fechahora', 'exa_equipo', 0);
INSERT INTO `admin_menu` VALUES (34, 'alianza_sedes', 'Sedes Empresas Grupo Alianza', 'Sedes de las Empresas del Grupo Alianza', '', '', 'axs_estado', 'axs_usu_id', 'axs_fechahora', 'axs_equipo', 0);
INSERT INTO `admin_menu` VALUES (35, 'depxdepal', 'Conf Departamentos', 'Configuración Departamentos Grupo Alianza con Depatamentos Recepción trámites', '', '', 'dxd_estado', 'dxd_usu_id', 'dxd_fechahora', 'dxd_equipo', 0);
...
CREATE TABLE `admin_tablas` (
  ...
  PRIMARY KEY  (`axt_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=160 ;

-- 
-- Volcar la base de datos para la tabla `admin_tablas`
-- 

INSERT INTO `admin_tablas` VALUES (123, 'empresa_cliente', 'exc_contacto', 0, 'required', '', '', '', '', '', '', 'Nombre persona contacto', 1, 0);
...
INSERT INTO `admin_tablas` VALUES (92, 'empresa_cliente', 'exc_nombre', 0, 'required', '', '', '', '', '', 'SI', 'Nombre Empresa Cliente', 1, 0);
...
INSERT INTO `admin_tablas` VALUES (127, 'empresa_cliente', 'exc_res_id', 0, 'cargos', '', '', '', '', '', '', 'Cargo Responsable Alianza', 1, 0);
...
INSERT INTO `admin_tablas` VALUES (141, 'dep_empresa', 'dxe_siglas', 0, 'required', '', '', '', '', '', '', 'Siglas Departamento', 1, 0);
...
INSERT INTO `alianza_dep` VALUES (1, 1, 'Depto sede1', '', 'hhhuuhuhu', 1, '2012-07-27 09:08:03', 0, '');
...
CREATE TABLE `alianza_emp` (
  ...
  PRIMARY KEY  (`exa_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Empresas Alianza' AUTO_INCREMENT=4 ;

-- 
-- Volcar la base de datos para la tabla `alianza_emp`
-- 

INSERT INTO `alianza_emp` VALUES (1, 'Constructora', '989898', '', '', '', 1, '2012-07-27 17:10:28', 1, 'MILE-PC');
INSERT INTO `alianza_emp` VALUES (2, 'Temporales', '909090', 'direccion', '898989', 'ninguna', 1, '2012-07-26 21:58:24', 1, 'MILE-PC');
INSERT INTO `alianza_emp` VALUES (3, 'Textiles', '909090', 'direccion', '898989', 'ninguna', 1, '2012-07-26 22:00:47', 1, 'MILE-PC');
...
INSERT INTO `dep_empresa` VALUES (1, 1, 'Depto uno sede uno', 'DUSU', '', 1, '2012-07-17 21:05:28', 1, 'MILE-PC');
INSERT INTO `dep_empresa` VALUES (2, 1, 'Depto dos SEDE uno', 'DDSU', '', 1, '2012-07-17 21:06:04', 1, 'MILE-PC');
INSERT INTO `dep_empresa` VALUES (3, 2, 'Depto uno Sede dos', 'DUSD', '', 1, '2012-07-17 21:08:17', 1, 'MILE-PC');
INSERT INTO `dep_empresa` VALUES (4, 2, 'Depto dos sede dos', 'DDSD', '', 1, '2012-07-17 21:08:40', 1, 'MILE-PC');
...
INSERT INTO `empresas_grupo` VALUES (2, 'PEQUEÑA', '', 1, '2012-07-10 20:54:22', 1, 'MILE-PC');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Empresas Cliente' AUTO_INCREMENT=2 ;

-- 
-- Volcar la base de datos para la tabla `empresa_cliente`
-- 

INSERT INTO `empresa_cliente` VALUES (1, '2012-07-28 00:00:15', 1, 3, 1, 'ARP Milenita', '654390', 'cra 28 calle 53', 6898284, 2147483647, '', 'Milena Martinez de la Rosa', 'mil@mail.com', 4, 1, 'MILE-PC');
...
INSERT INTO `usuario` VALUES (1, '1', 1, '2012-04-18 18:51:04', 1, 1, 1, 'Milena', ' Amaya de la Rosa', 'Pepito Perez', 78, 'mile', 'ea08e678edbf8892b8d67fc36f4a3bf9', 'milenaamaya@gmail.com', 'milenita@mail.com', 'direccion', '0', 0, '', 1, '');
INSERT INTO `usuario` VALUES (2, '1', 1, '2012-04-18 18:51:04', 1, 1, 1, 'Jorge', 'Bucay', 'Jorgito', 114578, 'mau', 'c20ad4d76fe97759aa27a0c99bff6710', 'milenaamaya@gmail.com', 'milenita@mail.com', 'Direccion', '678', 315667, 'Algunas observaciones', 1, '');
...
CREATE TABLE `usu_log` (
  ...
  PRIMARY KEY  (`uxl_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Tabla Verifica Usuario Activo' AUTO_INCREMENT=40 ;
...
INSERT INTO `usu_log` VALUES (38, 1, '1', 'Ingreso al SCTS', 'MILE-PC', '2012-07-30 22:34:28');
INSERT INTO `usu_log` VALUES (39, 1, '1', 'Ingreso al SCTS', 'MILE-PC', '2012-07-31 21:43:48');
