    ...
    */
	...
	if (dom)
	{
		...
		document.write ("</table></div><div id='selectMonth' style='z-index:+999;position:relative;visibility:hidden;'></div><div id='selectYear' style='z-index:+999;position:relative;visibility:hidden;'></div>");
	}
