...
-- 
-- Servidor: localhost
-- Tiempo de generación: 24-08-2012 a las 22:07:22
...
CREATE TABLE `admin_tablas` (
  ...
  PRIMARY KEY  (`axt_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=196 ;
...
INSERT INTO `admin_tablas` VALUES (89, 'tipo_empresacliente', 'txe_nombre', 0, 'text', '', '', '', '', '', 'SI', 'Nombre Clasificación', 1, 0, '');
...
INSERT INTO `cargos` VALUES (1, 'mile-pc', 1, 1, 'GERENTE GENERAL', 0, 'SIN LIDER', 1, '2012-08-15 18:31:34', 0);
...
INSERT INTO `depxdepal` VALUES (2, 2, 2, 1, '2012-08-23 23:46:54', 1, '127.0.0.1');
...
INSERT INTO `dep_empresa` VALUES (1, 1, 'DIRECTIVOS', '', 1, '2012-08-24 10:36:54', 1, '190.85.79.201');
...
INSERT INTO `empresas_tipo` VALUES (4, 'Clientes', 'Cliente es quien accede a un producto o servicio que ofrece el Grupo Alianza por medio de una transacción financiera (dinero) u otro medio de pago.', 0, '2012-08-15 10:37:26', '', '', 1);
...
INSERT INTO `empresa_cliente` VALUES (8, 2, '2012-08-24 10:33:00', 1, 3, 3, 'ARP Eddo', '787878', 'cra 28 calle 53', 6898284, 898989, '', 'miller', 'milr@mail.com', 3, 1, '');
...
CREATE TABLE `festivos` (
  ...
  `fes_fecha` date NOT NULL,
  PRIMARY KEY  (`fes_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Festivosdel año' AUTO_INCREMENT=1 ;
...
CREATE TABLE `tramite_frecuencia` (
  ...
  PRIMARY KEY  (`txf_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Frecuencia de los tramites en dias' AUTO_INCREMENT=10 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Pasos de los Tipo_Tramites' AUTO_INCREMENT=10 ;

-- 
-- Volcar la base de datos para la tabla `tramite_pasos`
-- 

INSERT INTO `tramite_pasos` VALUES (1, 56, 1, 1, 'PRIMERO', 'YGGYG', 4, 1, 1, '2012-08-23 19:48:35', 1, '127.0.0.1', '');
INSERT INTO `tramite_pasos` VALUES (2, 56, 1, 1, 'SEGUNDO', 'JHUHUHUHUH', 2, 1, 1, '2012-08-23 20:10:46', 1, '127.0.0.1', '');
...
INSERT INTO `tramite_pasos` VALUES (5, 57, 1, 6, 'VERIFICACION DE CONSUMOS', 'VERIFICAR HISTORICO DE CONSUMOS Y CARGOS NO AUTORIZADOS POR EL SUSCRIPTOR.', 1, 1, 1, '2012-08-24 10:00:44', 1, '190.85.79.201', '');
INSERT INTO `tramite_pasos` VALUES (6, 57, 1, 6, 'PAGO', 'REALIZAR PAGO ELECTRONICO Y EN ULTIMO CASO POR MENSAJERIA.', 1, 1, 1, '2012-08-24 10:03:31', 1, '190.85.79.201', '');
INSERT INTO `tramite_pasos` VALUES (7, 57, 1, 6, 'PAGO', 'REALIZAR PAGO ELECTRONICO Y EN ULTIMO CASO POR MENSAJERIA.', 1, 1, 1, '2012-08-24 10:03:34', 1, '190.85.79.201', '');
INSERT INTO `tramite_pasos` VALUES (8, 59, 1, 5, 'VERIFICAR SOPORTES Y AUXILIARES', 'VERIFICACION FISICA DE FACTURAS, VERIFICACION DE ANULADAS, NOTAS DEBITO Y CREDITO, CRUCE DE AUXILIARES.', 3, 1, 1, '2012-08-24 10:17:24', 1, '190.85.79.201', '');
INSERT INTO `tramite_pasos` VALUES (9, 59, 1, 5, 'PAGO ', '1. ENTREGAR BORRADOR FORMULARIO CON AUXILIARES DE COMPRAS Y VENTAS.\r\n2. SADASDDA\r\n3. SDFAFDF\r\n4. DAFAFD\r\n5. AWEFQWEF\r\n\r\n\r\n', 1, 1, 1, '2012-08-24 10:19:42', 1, '190.85.79.201', '');
...
INSERT INTO `tramite_tipo` VALUES (56, 3, 'AACON', 32, 'S', 4, '2012-08-25', '2012-12-25', 'ES EL PRIMER TRAMITE MENSUAL', 6, 1, 1, '2012-08-23 18:32:13', 1, '127.0.0.1', '');
INSERT INTO `tramite_tipo` VALUES (57, 3, 'PAGO DE ENERGIA OFICINA', 0, 'S', 5, '2012-08-14', '2012-08-14', 'PAGO OPORTUNO DE ENERGIA OFICINA', 2, 1, 1, '2012-08-24 09:45:07', 1, '190.85.79.201', '');
INSERT INTO `tramite_tipo` VALUES (58, 8, 'CORTE GIRARDOT VILLA MARIA', 1, 'S', 50, '2012-08-25', '2012-08-25', '', 5, 1, 1, '2012-08-24 09:55:56', 1, '190.85.79.201', '');
INSERT INTO `tramite_tipo` VALUES (59, 9, 'PAGO IVA GESTION ALIANZA', 0, 'S', 3, '2012-09-12', '0000-00-00', 'PREPARACION PAGO IMPUESTO A LAS VENTAS BIMESTRAL', 4, 1, 1, '2012-08-24 10:14:53', 1, '190.85.79.201', '');
...
INSERT INTO `usuario` VALUES (5, '1', 1, '2012-08-15 19:42:17', 0, 1, 2, 'eDUARDO', 'GRANADA', 'EDDO', 794444, 'ed95_granada', '18e9a4e174a546758ce0f57b92b74a4b', 'EDO@MAIL.COM', 'EDO@MAIL.COM', 'CALLE 200', '7878N', 3187676, 'LEJOS', 1, '');
...
CREATE TABLE `usu_log` (
  ...
  PRIMARY KEY  (`uxl_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Tabla Verifica Usuario Activo' AUTO_INCREMENT=17 ;

-- 
-- Volcar la base de datos para la tabla `usu_log`
-- 

INSERT INTO `usu_log` VALUES (1, 1, '1', 'Ingreso al SCTS', '190.85.79.201', '2012-08-24 09:39:36');
INSERT INTO `usu_log` VALUES (2, 1, '1', 'Ingreso registro tabla tramite_tipo', '190.85.79.201', '2012-08-24 09:45:07');
INSERT INTO `usu_log` VALUES (3, 1, '1', 'Ingreso registro tabla tramite_frecuencia', '190.85.79.201', '2012-08-24 09:48:17');
INSERT INTO `usu_log` VALUES (4, 1, '1', 'Ingreso registro tabla tramite_tipo', '190.85.79.201', '2012-08-24 09:55:56');
INSERT INTO `usu_log` VALUES (5, 1, '1', 'Ingreso registro tabla tramite_pasos', '190.85.79.201', '2012-08-24 10:00:44');
INSERT INTO `usu_log` VALUES (6, 1, '1', 'Ingreso registro tabla tramite_pasos', '190.85.79.201', '2012-08-24 10:03:31');
INSERT INTO `usu_log` VALUES (7, 1, '1', 'Ingreso registro tabla tramite_pasos', '190.85.79.201', '2012-08-24 10:03:34');
INSERT INTO `usu_log` VALUES (8, 1, '1', 'Ingreso registro tabla tramite_frecuencia', '190.85.79.201', '2012-08-24 10:05:55');
INSERT INTO `usu_log` VALUES (9, 1, '1', 'Ingreso registro tabla tramite_tipo', '190.85.79.201', '2012-08-24 10:14:53');
INSERT INTO `usu_log` VALUES (10, 1, '1', 'Ingreso registro tabla tramite_pasos', '190.85.79.201', '2012-08-24 10:17:24');
INSERT INTO `usu_log` VALUES (11, 1, '1', 'Ingreso registro tabla tramite_pasos', '190.85.79.201', '2012-08-24 10:19:42');
INSERT INTO `usu_log` VALUES (12, 1, '1', 'Modifico tabla empresa_cliente', '190.85.79.201', '2012-08-24 10:33:13');
INSERT INTO `usu_log` VALUES (13, 1, '1', 'Ingreso registro tabla dep_empresa', '190.85.79.201', '2012-08-24 10:35:48');
INSERT INTO `usu_log` VALUES (14, 1, '1', 'Modifico tabla dep_empresa', '190.85.79.201', '2012-08-24 10:36:44');
INSERT INTO `usu_log` VALUES (15, 1, '1', 'Modifico tabla dep_empresa', '190.85.79.201', '2012-08-24 10:37:01');
INSERT INTO `usu_log` VALUES (16, 1, '1', 'Ingreso registro tabla cargos', '190.85.79.201', '2012-08-24 10:38:03');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `tramites`.`v_usuario` AS select `b`.`usu_id` AS `usu_id`,`b`.`usu_car_id` AS `usu_car_id`,`a`.`car_dxe_id` AS `car_dxe_id`,concat(`a`.`car_nombre`,_utf8' - ',`b`.`usu_nombre`) AS `nom` from (`tramites`.`cargos` `a` join `tramites`.`usuario` `b` on(((`a`.`car_id` = `b`.`usu_car_id`) and (`b`.`usu_estado` = 1))));
